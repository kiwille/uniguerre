...
THREEx.Planets.createSun	= function(){
	...
	var material	= new THREE.MeshPhongMaterial({
		map		: THREE.ImageUtils.loadTexture(THREEx.Planets.baseURL+'/sun03.jpg'),
		bumpScale	: 0.05
	});
...
THREEx.Planets.createPlanet	= function(){
	var geometry	= new THREE.SphereGeometry(0.5, 32, 32);
	var material	= new THREE.MeshPhongMaterial({
...
THREEx.Planets.createSunDynamics	= function(){
...
THREEx.Planets.createCloud	= function(){
	// create destination canvas
	var canvasResult	= document.createElement('canvas');
	canvasResult.width	= 1024;
	canvasResult.height	= 512;
...
THREEx.Planets.createMoon	= function(){
	var geometry	= new THREE.SphereGeometry(0.5, 32, 32);
	var material	= new THREE.MeshPhongMaterial({
		map	: THREE.ImageUtils.loadTexture(THREEx.Planets.baseURL+'/lune02.jpg'),
		bumpScale: 0.002
	});
	var mesh	= new THREE.Mesh(geometry, material);
	return mesh;	
...
THREEx.Planets.createRing	= function(){
	// create destination canvas
	var canvasResult	= document.createElement('canvas');
